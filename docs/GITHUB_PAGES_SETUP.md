...
This document describes how Metacrafter documentation is deployed to GitHub Pages at
`https://apicrafter.github.io/metacrafter/`.

## Prerequisites

1. The repository `apicrafter/metacrafter`
...
- **Base URL**: `/metacrafter/`
- **Organization**: `apicrafter`
- **Project**: `metacrafter`

The published site is available at `https://apicrafter.github.io/metacrafter/`.
...
2. **Push to the main branch**:
   - The GitHub Actions workflow (`.github/workflows/deploy-docs.yml`) will:
     - Build the Docusaurus site when changes are pushed to `main` or `master`
     - Deploy to GitHub Pages
   - The workflow triggers on:
     - Pushes to `main`/`master` that affect files in `docs/`
...
- **404 errors**: Verify `baseUrl` in `docusaurus.config.js` is `/metacrafter/`
